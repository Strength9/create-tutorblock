...
exports.acfBlock = function() {
    ...
    console.clear();
    console.log('Create Tutor Block is running...');
    console.log('');
    console.log('This will create a new folder in the current directory containing scaffolding for a new WordPress Tutor Block.');
    console.log('');
